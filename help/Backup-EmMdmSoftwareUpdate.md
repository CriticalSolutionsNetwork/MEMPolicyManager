...
online version: https://criticalsolutionsnetwork.github.io/MemPolicyManager/#Backup-EmMdmSoftwareUpdate
schema: 2.0.0
---
...
```
Backup-EmMdmSoftwareUpdate [-ExportPath] <String> [[-AuthObject] <EmMdmAuthBase>] [[-graphApiVersion] <String>]
...
### -ExportPath
The directory path where the Software Update policies will be exported.

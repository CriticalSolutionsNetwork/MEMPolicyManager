...
online version: https://criticalsolutionsnetwork.github.io/MemPolicyManager/#Import-EmMdmAppProtection
schema: 2.0.0
---
...
```
Import-EmMdmAppProtection [-ImportPath] <String> [[-AuthObject] <EmMdmAuthBase>] [[-graphApiVersion] <String>]
...
### -ImportPath
The file path to the JSON file containing the App Protection policy to import.
